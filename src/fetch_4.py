...
def consultar_cotacao_bitcoin():
    try:
        ...
        quote = bitcoin_data.get_brl_quote()

        # Imprimir os dados da cotação
        print(f"Última cotação do Bitcoin: ${quote.price:.2f} BRL")
        print(f"Volume 24h: ${quote.volume_24h:.2f} BRL")
        print(f"Market Cap: ${quote.market_cap:.2f} BRL")
